...
class PyMon:
    ...
    def get_code_list(self):
        self.kospi_codes = self.kiwoom.My_GetCodeListByMarket(MARKET_KOSPI)
        self.kosdak_codes = self.kiwoom.My_GetCodeListByMarket(MARKET_KOSDAK)

    def get_ohlcv(self, code, start_date):
        # Init data structure
        self.kiwoom.My_InitOHLCRawData()
        ...
        self.kiwoom.My_CommRqData("opt10081_req", "opt10081", 0, "0101")
        time.sleep(0.2)
